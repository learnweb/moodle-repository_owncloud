...
class repository_owncloud2 extends repository {
    ...
    public static function type_config_form($mform, $classname = 'repository') {
        ...
        $mform->addRule('issuer', $strrequired, 'required', null, 'issuer');

        $mform->setType('issuer', PARAM_RAW_TRIMMED);

        // TODO check for webdav endpoint
        /*if (has_capability('moodle/site:config', $sitecontext)) {
    ...
    public static function type_form_validation($mform, $data, $errors) {
        return parent::type_form_validation($mform, $data, $errors); // TODO: Change the autogenerated stub
    }
